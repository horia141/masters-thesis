...
fprintf('Experiment "Corr and GlobalOrder - MNIST - Intuitive"\n');
...
[s_tr,ci_tr] = dataset.load('../../data/mnist.train.mat');

fprintf('%d observations.\n',dataset.count(s_tr));

fprintf('  Loading test sample ... ');

[s_ts,ci_ts] = dataset.load('../../data/mnist.test.mat');
