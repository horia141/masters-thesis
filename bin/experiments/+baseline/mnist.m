...
RESULTS_PATH = '../../explogs/baseline/mnist/results_1.mat';
...
fprintf('Experiment "Baseline - MNIST"\n');
...
for coder_idx = 1:length(param_list_coder)
    ...
    for coder_rep_idx = 1:CODER_REP_COUNT
        ...
        s_coder_useful_coded = sparse(dataset.flatten_image(s_coder_useful));
        s_ts_coded = sparse(dataset.flatten_image(s_ts));
