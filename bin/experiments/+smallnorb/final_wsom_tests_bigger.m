...
RESULTS_PATH = '../explogs/smallnorb/final_wsom_tests_bigger/results_2_Gradient_MP25.mat';
...
% Coding method.
param_desc_coder.patches_count = 200000;
param_desc_coder.do_patch_zca = true;
param_desc_coder.dictionary_type = 'Learn:Grad';
param_desc_coder.dictionary_params = {{512 'MP' 25 10 1 20}};
% Coder transforms.
...
% Coder geometry.
param_desc_coder.window_size = 17;
param_desc_coder.window_step = 3;
param_desc_coder.reduce_spread = 3;
...
param_desc_classifier.reg = logspace(-3,0,20);
...
logg.beg_node('Experiment "SmallNORB - Final WSOM Tests (Bigger)"');
