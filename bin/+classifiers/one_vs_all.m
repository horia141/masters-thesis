classdef one_vs_all < classifier
        ...
        function [obj] = one_vs_all(train_sample,class_info,classifier_ctor_fn,params,logger)
            ...
            try
                for ii = 1:class_info.labels_count
                    local_ci = classification_info({'One' 'All'},(class_info.labels_idx ~= ii) + 1);
                    classifier_list_t{ii} = classifier_ctor_fn(train_sample,local_ci,local_params{ii}{:},logger.new_classifier('Classifier for %s-vs-All',class_info.labels{ii}));
                end
            catch exp
                logger.end_node();
    ...
    methods (Static,Access=public)
        function test(display)
            ...
            cl = classifiers.one_vs_all(s,ci,@classifiers.svm,{'linear' 0 1},log);
            ...
            cl = classifiers.one_vs_all(s,ci,@classifiers.svm,{'rbf' 0.7 1},log);
            ...
            cl = classifiers.one_vs_all(s,ci,@classifiers.svm,{{'linear' 0 1} {'rbf' 0.7 1} {'poly' 3 1}},log);
            ...
            cl = classifiers.one_vs_all(s_tr,ci_tr,@classifiers.svm,{'linear' 0 1},log);
            ...
            cl = classifiers.one_vs_all(s_tr,ci_tr,@classifiers.svm,{'rbf' 0.5 1},log);
            ...
            cl = classifiers.one_vs_all(s_tr,ci_tr,@classifiers.svm,{'rbf' 0.1 1},log);
