classdef svm_linear < classifier
    ...
    methods (Static,Access=public)
        function test(display)
            ...
            cl = classifiers1.svm_linear(s,ci,'Primal','L2','L1',1,'1va',1,log);
            ...
            assert(tc.same(hnd.logged_data,sprintf(strcat('Training each classifier:\n',...
                                                          ...
                                                          '      Classes Count: 3\n',...
                                                          '      Method: L2-loss L1-regularized support vector classification in primal form\n',...
            ...
            cl = classifiers1.svm_linear(s,ci,'Primal','L2','L1',1,'1v1',1,log);
            ...
            cl = classifiers1.svm_linear(s,ci,'Primal','L2','L2',1,'1va',1,log);
            ...
            assert(tc.same(hnd.logged_data,sprintf(strcat('Training each classifier:\n',...
                                                          ...
                                                          '      Train Sample Geometry: 2\n',...
                                                          '      Classes Count: 3\n',...
                                                          '      Method: L2-loss L2-regularized support vector classification in primal form\n',...
                                                          '      Regularization Parameter: 1.000000\n',...
                                                          '      Number of Worker Threads: 1\n',...
                                                          '      Average Number of Non-Null Entries: 2\n',...
                                                          '      Total Number of Non-Null Entries: 600\n',...
            ...
            cl = classifiers1.svm_linear(s,ci,'Primal','L2','L2',1,'1v1',1,log);
            ...
            cl = classifiers1.svm_linear(s,ci,'Dual','L1','L2',1,'1va',1,log);
            ...
            assert(tc.same(hnd.logged_data,sprintf(strcat('Training each classifier:\n',...
                                                          ...
                                                          '      Train Sample Geometry: 2\n',...
                                                          '      Classes Count: 3\n',...
                                                          '      Method: L1-loss L2-regularized support vector classification in dual form\n',...
                                                          '      Regularization Parameter: 1.000000\n',...
                                                          '      Number of Worker Threads: 1\n',...
                                                          '      Average Number of Non-Null Entries: 2\n',...
                                                          '      Total Number of Non-Null Entries: 600\n',...
            ...
            cl = classifiers1.svm_linear(s,ci,'Dual','L1','L2',1,'1v1',1,log);
            ...
            cl = classifiers1.svm_linear(s,ci,'Dual','L2','L2',1,'1va',1,log);
            ...
            assert(tc.same(hnd.logged_data,sprintf(strcat('Training each classifier:\n',...
                                                          ...
                                                          '      Train Sample Geometry: 2\n',...
                                                          '      Classes Count: 3\n',...
                                                          '      Method: L2-loss L2-regularized support vector classification in dual form\n',...
                                                          '      Regularization Parameter: 1.000000\n',...
                                                          '      Number of Worker Threads: 1\n',...
                                                          '      Average Number of Non-Null Entries: 2\n',...
                                                          '      Total Number of Non-Null Entries: 600\n',...
            ...
            cl = classifiers1.svm_linear(s,ci,'Dual','L2','L2',1,'1v1',1,log);
            ...
            cl = classifiers1.svm_linear(s,ci,'Primal','L2','L1',1,'1va',3,log);
            ...
            cl = classifiers1.svm_linear(s,ci,'Primal','L2','L1',1,'1v1',3,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Primal','L2','L1',1,'1va',1,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Primal','L2','L1',1,'1v1',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Primal','L2','L2',1,'1va',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Primal','L2','L2',1,'1v1',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Dual','L1','L2',1,'1va',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Dual','L1','L2',1,'1v1',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Dual','L2','L2',1,'1va',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
            ...
            cl = classifiers1.svm_linear(s_tr,ci_tr,'Dual','L2','L2',1,'1v1',1,log);
            [labels_idx_hat,labels_confidence,score,conf_matrix,misclassified] = cl.classify(s_ts,ci_ts,log);
