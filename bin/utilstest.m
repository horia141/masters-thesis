classdef utilstest
    methods (Static,Access=public)
        ...
        function [cifar10_tr,cifar10_tr_ci,cifar10_ts,cifar10_ts_ci] = load_cifar10_original(logger)
            assert(tc.scalar(logger));
            assert(tc.logging_logger(logger));
            assert(logger.active);
            ...
            [cifar10_tr,cifar10_tr_ci] = dataset.load_image_cifar({'../data/cifar10/data_batch_1.mat' ...
                                                                  ...
                                                                  '../data/cifar10/batches.meta.mat','original',logger);
            [cifar10_ts,cifar10_ts_ci] = dataset.load_image_cifar('../data/cifar10/test_batch.mat','../data/cifar10/batches.meta.mat','original',logger);
        end
        
        function [cifar10_tr,cifar10_tr_ci,cifar10_ts,cifar10_ts_ci] = load_cifar10_gray(logger)
            assert(tc.scalar(logger));
            assert(tc.logging_logger(logger));
            assert(logger.active);
            ...
            [cifar10_tr,cifar10_tr_ci] = dataset.load_image_cifar({'../data/cifar10/data_batch_1.mat' ...
                                                                   ...
                                                                   '../data/cifar10/data_batch_4.mat' ...
                                                                   '../data/cifar10/data_batch_5.mat'},...
                                                                  '../data/cifar10/batches.meta.mat','gray',logger);
            [cifar10_ts,cifar10_ts_ci] = dataset.load_image_cifar('../data/cifar10/test_batch.mat','../data/cifar10/batches.meta.mat','gray',logger);
        end
        
        function [cifar100_tr,cifar100_tr_ci,cifar100_ts,cifar100_ts_ci] = load_cifar100_original(logger)
            assert(tc.scalar(logger));
            assert(tc.logging_logger(logger));
            assert(logger.active);
            
            [cifar100_tr,cifar100_tr_ci] = dataset.load_image_cifar('../data/cifar100/train.mat','../data/cifar100/meta.mat','original',logger);
            [cifar100_ts,cifar100_ts_ci] = dataset.load_image_cifar('../data/cifar100/test.mat','../data/cifar100/meta.mat','original',logger);
        end
        
        function [cifar100_tr,cifar100_tr_ci,cifar100_ts,cifar100_ts_ci] = load_cifar100_gray(logger)
            assert(tc.scalar(logger));
            assert(tc.logging_logger(logger));
            assert(logger.active);
            
            [cifar100_tr,cifar100_tr_ci] = dataset.load_image_cifar('../data/cifar100/train.mat','../data/cifar100/meta.mat','gray',logger);
            [cifar100_ts,cifar100_ts_ci] = dataset.load_image_cifar('../data/cifar100/test.mat','../data/cifar100/meta.mat','gray',logger);
        end
