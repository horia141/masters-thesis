...
svm_classifier = @(s,ci,kt,kp,l)classifiers.one_vs_one(s,ci,@classifiers.svm,{kt kp},l);
...
experiments.small_images('MNIST: PCA on linearized images with CMeans and SVM classifiers',...
                         ...
                         @(s,ci,p,l)architectures.arch_pca(s,ci,p.kept_energy,p.classifier_ctor_fn,utils.cell_cull({p.kernel_type,p.kernel_param}),l),...
