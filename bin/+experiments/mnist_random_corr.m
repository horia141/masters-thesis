...
experiments.small_images('MNIST: Filtering using random bases with CMeans and SVM classifiers',...
                         ...
                         @(s,p,l)architectures.arch_random_corr(s,p.filters_count,p.filter_row_count,p.filter_col_count,p.reduce_function,p.reduce_spread,p.classifier_ctor_fn,utils.cell_cull({p.kernel_type,p.kernel_param}),l),...
