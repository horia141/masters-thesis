...
MODEL_SELECTION_RATIO = [[[{unitreal or "full" and unitreal}]]]
TRAIN_VALIDATION_RATIO = [[[unitreal]]];
CODER_REP_COUNT = [[[natural > 0]]];
CLASSIFIER_REP_COUNT = [[[natural > 0]]];
RESULTS_PATH = '../explogs/[[[dataset directory]]]/[[[experiment directory]]]/results.mat';
...
param_desc_coder.dictionary_params = {{100 'MP' 5 1 0.01 20}};
