...
RESULTS_PATH = '../explogs/smallnorb/sparse_coding_neural_gas/test_2_std/results_1_CCmp11_w256_p13_k11_s3.mat.mat';
...
load ../explogs/smallnorb/sparse_coding_neural_gas/saved_dict_mp11_13x13_256_zca.mat
...
logg.beg_node('Experiment "SmallNORB - Sparse Coding Neural Gas - Test 2 Standardize"');
...
for coder_idx = 1:length(param_list_coder)
    ...
    for coder_rep_idx = 1:CODER_REP_COUNT
        ...
        d_coder_useful_coded_t = coders{coder_rep_idx,coder_idx}.code(d_coder_useful,logg.new_node('Coding model selection data'));
        d_ts_coded_t = coders{coder_rep_idx,coder_idx}.code(d_ts,logg.new_node('Coding final testing data'));

        t_standardize = transforms.record.standardize(d_coder_useful_coded_t,logg);
        d_coder_useful_coded = t_standardize.code(d_coder_useful_coded_t,logg);
	d_ts_coded = t_standardize.code(d_ts_coded_t,logg);
