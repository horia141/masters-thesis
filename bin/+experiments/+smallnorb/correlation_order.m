...
RESULTS_PATH = '../explogs/smallnorb/correlation_order/results_1_RandomFilters_f0.1_w512_p13_k11_s3.mat';
...
param_desc_coder.dictionary_params = {{512 'CorrOrder' [0.1 0.01 16]}};
% Coder transforms.
...
logg.beg_node('Experiment "SmallNORB - Baseline Intuitive"');
