classdef pca_whitening < transforms.reversible
    ...
    methods (Access=public)
        function [obj] = pca_whitening(train_sample_plain,kept_energy,logger,div_epsilon)
    ...
    methods (Static,Access=public)
        function test(display)
            fprintf('Testing "transforms.record.pca_whitening".\n');
            ...
            t2 = transforms.record.pca_whitening(s3,0.95,log);
            s3_p = t2.code(s3,log);
            ...
            t2 = transforms.record.pca_whitening(s3,1,log);
            s3_p = t2.code(s3,log);
            s3_r = t2.decode(s3_p,log);
