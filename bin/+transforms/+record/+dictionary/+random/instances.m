classdef instances < transforms.record.dictionary
    ...
    methods (Static,Access=public)
        function test(display)
            ...
            t = transforms.record.dictionary.random.instances(s,3,'MP',1,log);
            ...
            t = transforms.record.dictionary.random.instances(s,3,'OMP',1,log);
            ...
            t = transforms.record.dictionary.random.instances(s,3,'MP',2,log);
            s_p = t.code(s,log);
            ...
            t = transforms.record.dictionary.random.instances(s,3,'OMP',2,log);
            s_p = t.code(s,log);
            ...
            t = transforms.record.dictionary.random.instances(s,2,'Corr',[],log);
            s_p = t.code(s,log);
            s_r = t.decode(s_p,log);
